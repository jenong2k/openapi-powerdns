...
------------ | ------------- | ------------- | -------------
*AutoprimaryApi* | [**createAutoprimary**](docs/Api/AutoprimaryApi.md#createautoprimary) | **POST** /servers/{server_id}/autoprimaries | Add an autoprimary
*AutoprimaryApi* | [**deleteAutoprimary**](docs/Api/AutoprimaryApi.md#deleteautoprimary) | **DELETE** /servers/{server_id}/autoprimaries/{ip}/{nameserver} | Delete the autoprimary entry
*AutoprimaryApi* | [**getAutoprimaries**](docs/Api/AutoprimaryApi.md#getautoprimaries) | **GET** /servers/{server_id}/autoprimaries | Get a list of autoprimaries
...
*TsigkeyApi* | [**createTSIGKey**](docs/Api/TsigkeyApi.md#createtsigkey) | **POST** /servers/{server_id}/tsigkeys | Add a TSIG key
*TsigkeyApi* | [**deleteTSIGKey**](docs/Api/TsigkeyApi.md#deletetsigkey) | **DELETE** /servers/{server_id}/tsigkeys/{tsigkey_id} | Delete the TSIGKey with tsigkey_id
*TsigkeyApi* | [**getTSIGKey**](docs/Api/TsigkeyApi.md#gettsigkey) | **GET** /servers/{server_id}/tsigkeys/{tsigkey_id} | Get a specific TSIGKeys on the server, including the actual key
*TsigkeyApi* | [**listTSIGKeys**](docs/Api/TsigkeyApi.md#listtsigkeys) | **GET** /servers/{server_id}/tsigkeys | Get all TSIGKeys on the server, except the actual key
*TsigkeyApi* | [**putTSIGKey**](docs/Api/TsigkeyApi.md#puttsigkey) | **PUT** /servers/{server_id}/tsigkeys/{tsigkey_id} | 
...
*ZonemetadataApi* | [**getMetadata**](docs/Api/ZonemetadataApi.md#getmetadata) | **GET** /servers/{server_id}/zones/{zone_id}/metadata/{metadata_kind} | Get the content of a single kind of domain metadata as a Metadata object.
...
*ZonemetadataApi* | [**modifyMetadata**](docs/Api/ZonemetadataApi.md#modifymetadata) | **PUT** /servers/{server_id}/zones/{zone_id}/metadata/{metadata_kind} | Replace the content of a single kind of domain metadata.
...
*ZonesApi* | [**putZone**](docs/Api/ZonesApi.md#putzone) | **PUT** /servers/{server_id}/zones/{zone_id} | Modifies basic zone data.
