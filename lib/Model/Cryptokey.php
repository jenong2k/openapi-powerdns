...
class Cryptokey implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Cryptokey';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['cds'] = isset($data['cds']) ? $data['cds'] : null;
     ...
     * Sets published
     *
     * @param bool $published Whether or not the DNSKEY record is published in the zone
     *
     * @return $this
     */
     ...
     * Sets cds
     *
     * @param string[] $cds An array of DS records for this key, filtered by CDS publication settings
     *
     * @return $this
     */
