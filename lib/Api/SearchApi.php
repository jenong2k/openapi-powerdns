...
class SearchApi
{
     ...
     * @param  string $object_type Type of data to search for, one of “all”, “zone”, “record”, “comment” (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\SearchResults
     */
    public function searchData($server_id, $q, $max, $object_type = null)
    {
        list($response) = $this->searchDataWithHttpInfo($server_id, $q, $max, $object_type);
        return $response;
    }
     ...
     */
    public function searchDataWithHttpInfo($server_id, $q, $max, $object_type = null)
    {
        $returnType = '\Swagger\Client\Model\SearchResults';
        $request = $this->searchDataRequest($server_id, $q, $max, $object_type);
     ...
     */
    public function searchDataAsync($server_id, $q, $max, $object_type = null)
    {
        return $this->searchDataAsyncWithHttpInfo($server_id, $q, $max, $object_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchDataAsyncWithHttpInfo($server_id, $q, $max, $object_type = null)
    {
        $returnType = '\Swagger\Client\Model\SearchResults';
        $request = $this->searchDataRequest($server_id, $q, $max, $object_type);
     ...
     */
    protected function searchDataRequest($server_id, $q, $max, $object_type = null)
    {
        // verify the required parameter 'server_id' is set
        if ($server_id === null || (is_array($server_id) && count($server_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $server_id when calling searchData'
            );
        }
        ...
        // query params
        if ($object_type !== null) {
            $queryParams['object_type'] = ObjectSerializer::toQueryValue($object_type);
        }
